...
/** \file
 * Header file where is the EpuckDriver2_1 class, for Player version 2.1
 */
 ...
 * \date November 2008
 */
class EpuckDriver2_1 : public Driver
{
public:

  EpuckDriver2_1(ConfigFile* cf, int section);
  ...
  static void EpuckDriver2_1_Register(DriverTable* table);

  static Driver* EpuckDriver2_1_Init(ConfigFile* cf, int section);
