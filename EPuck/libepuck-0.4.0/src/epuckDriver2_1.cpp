...
EpuckDriver2_1::EpuckDriver2_1(ConfigFile* cf, int section)
...
EpuckDriver2_1::~EpuckDriver2_1()
{
  delete serialPort;
}

int
EpuckDriver2_1::Setup()
{
...
int
EpuckDriver2_1::Subscribe(player_devaddr_t addr)
{
...
int
EpuckDriver2_1::Unsubscribe(player_devaddr_t addr)
{
  if(addr.interf == PLAYER_POSITION2D_CODE)
  {
...
int
EpuckDriver2_1::ProcessMessage(QueuePointer &resp_queue,
...
Driver*
EpuckDriver2_1::EpuckDriver2_1_Init(ConfigFile* cf, int section)
{
  return((Driver*)(new EpuckDriver2_1(cf, section)));
}

void
EpuckDriver2_1::EpuckDriver2_1_Register(DriverTable* table)
{
  table->AddDriver((char*)"epuck", EpuckDriver2_1_Init);
}

/*! \relates EpuckDriver2_1
...
extern "C"
{
  int player_driver_init(DriverTable* table)
  {
    ...
    EpuckDriver2_1::EpuckDriver2_1_Register(table);
    return (0);
  }
}
