...
server/CMakeFiles/player.dir/server.o: ../server/server.cc
	...
	cd /usr/local/src/player-3.0.2/build/server && /usr/bin/c++   $(CXX_DEFINES) $(CXX_FLAGS) -o CMakeFiles/player.dir/server.o -c /usr/local/src/player-3.0.2/server/server.cc
...
server/CMakeFiles/player.dir/server.i: cmake_force
	...
	cd /usr/local/src/player-3.0.2/build/server && /usr/bin/c++  $(CXX_DEFINES) $(CXX_FLAGS) -E /usr/local/src/player-3.0.2/server/server.cc > CMakeFiles/player.dir/server.i
...
server/CMakeFiles/player.dir/server.s: cmake_force
	...
	cd /usr/local/src/player-3.0.2/build/server && /usr/bin/c++  $(CXX_DEFINES) $(CXX_FLAGS) -S /usr/local/src/player-3.0.2/server/server.cc -o CMakeFiles/player.dir/server.s
...
server/player: server/CMakeFiles/player.dir/link.txt
	...
	cd /usr/local/src/player-3.0.2/build/server && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/player.dir/link.txt --verbose=$(VERBOSE)
...
server/CMakeFiles/player.dir/clean:
	cd /usr/local/src/player-3.0.2/build/server && $(CMAKE_COMMAND) -P CMakeFiles/player.dir/cmake_clean.cmake
.PHONY : server/CMakeFiles/player.dir/clean

server/CMakeFiles/player.dir/depend:
	cd /usr/local/src/player-3.0.2/build && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /usr/local/src/player-3.0.2 /usr/local/src/player-3.0.2/server /usr/local/src/player-3.0.2/build /usr/local/src/player-3.0.2/build/server /usr/local/src/player-3.0.2/build/server/CMakeFiles/player.dir/DependInfo.cmake --color=$(COLOR)
